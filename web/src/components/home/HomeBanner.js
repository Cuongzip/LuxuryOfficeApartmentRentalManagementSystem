  ...
  return (
    <section className="px-4 md:px-16 py-6 md:py-10 bg-white">
      <div className=" mx-auto">
        {/* Desktop Layout (Interlocking puzzle cards with rounded corners) */}
        <div className="relative w-full h-[580px] hidden md:block">
          {/* Top-Left part of the Blue Card */}
          ...
          {/* Inner Corner Mask for the single L-shaped Blue Card */}
          <svg
          ...
          {/* Bottom-Left part of the Blue Card */}
          <div className="absolute top-[41%] left-0 w-[57%] h-[35%] bg-[#e2ebfc] rounded-tr-[1.5rem] rounded-br-[1.5rem] rounded-bl-[1.5rem] px-8 py-7 flex flex-col justify-between z-20">
          ...
          <div className="absolute top-[80%] bottom-0 left-0 w-[57%] h-[20%] bg-[#1c1c1c] rounded-[1.5rem] px-10 py-6 shadow-sm z-20">
          ...
          {/* White Cover Mask to shape the image container stepped layout */}
          <div className="absolute left-[40%] top-[37%] w-[19%] bottom-0 bg-white z-10 pointer-events-none rounded-tr-[1.5rem]"></div>

          {/* Mask 1: Round the bottom-left of the top part of the image */}
          <svg
          ...
          {/* Mask 3: Round the bottom-left of the bottom part of the image */}
          <svg
        ...
        {/* Mobile / Tablet Layout (Stacked blocks) */}
